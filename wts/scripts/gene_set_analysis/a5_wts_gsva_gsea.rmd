...
all_genesets <- c(Hs.H.list, jansky.genesets.list, zethoven.celltypes.list, zethoven_ben_met)
...
useful_contrasts <- c("Parasympathetic_vs_Sympathetic", "TERT_All_vs_NonTERT", "ATRX_All_vs_NonATRX", "Metastasis_All_vs_NonMetPri_WT")
