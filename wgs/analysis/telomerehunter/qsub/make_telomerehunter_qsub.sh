...
cytobands="/g/data/pq08/projects/ppgl/a5/software/telomerehunter_conda/reference/GRCh38.cytoBand_primary.txt"
echo "
...
conda activate /g/data/pq08/projects/ppgl/a5//software/telomerehunter_conda/
