...
{ 
  diff_meth_result <- readRDS("./methylation/quickload_checkpoints/ruv_diffmeth_result.rds")
} else
{
  ...
  saveRDS(gsea_result, "./methylation/quickload_checkpoints/ruv_diffmeth_result.rds")
}
...
if(quickload_dmr)
{ 
  dmr_lists <- readRDS("./methylation/quickload_checkpoints/dmr_result.rds")
} else
{
  ...
  saveRDS(dmr_lists, "./methylation/quickload_checkpoints/dmr_result.rds")
}
...
if(quickload_gsea)
{ 
  gsea_result <- readRDS("./methylation/quickload_checkpoints/gsea_result.rds")
} else
{
  gsea_result <- list()
